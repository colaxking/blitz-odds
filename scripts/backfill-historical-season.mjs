...
function brandWordmarkSvg(height) {
  ...
  return `<svg width="${w}" height="${h}" viewBox="0 0 660 220" style="flex-shrink:0">
      ...
      <g transform="translate(295,90) scale(0.872) translate(-120,-100)">
        ...
        <g transform="rotate(-28 110 112)">
          <ellipse cx="110" cy="112" rx="74" ry="41" fill="#0c1526" stroke="#f4f7fb" stroke-width="4.5"/>
          <path d="M 64 112 Q 110 97 156 112" fill="none" stroke="#f4f7fb" stroke-width="3.5"/>
