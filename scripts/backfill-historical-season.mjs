...
// the real logo artwork as two theme-swapped PNGs (branding/blitz-odds-wordmark-dark.png
// and -light.png), toggled via the [data-theme] CSS rules in PAGE_CSS. Keep in
// sync with index.html if the mark ever changes.
function brandWordmarkSvg(height) {
  ...
  return `<span class="brand-logo-wrap" style="display:inline-flex;align-items:center;flex-shrink:0">
      <img src="/branding/blitz-odds-wordmark-dark.png" alt="Blitz Odds" class="brand-logo-img brand-logo-dark" style="height:${h}px;width:auto;display:block" />
      <img src="/branding/blitz-odds-wordmark-light.png" alt="Blitz Odds" class="brand-logo-img brand-logo-light" style="height:${h}px;width:auto;display:none" />
    </span>`;
}
